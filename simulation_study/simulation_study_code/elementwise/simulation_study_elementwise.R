...
setwd("/Users/madhusreechowdhury/Desktop/Project_2_Revised 2/simulation_study_v3/simulation_study_output/elementwise/")
...
L <- matrix(c(3,0,0,3,4
              ...
              ,3,3,5,4,5
              ,2,2,3,5,3
              ,4,4,4,5,5),nrow=d,ncol=d,byrow = TRUE) # HLag- elementwise
...
for(penalty in all_penalties){
  ...
  filename1 = paste(paste(Hlag_structure,"actual_plot",sep="_"),"png",sep=".")
  png(filename1)
  ...
  filename2 = paste(paste(penalty,Hlag_structure,"estimated_plot_bic",sep="_"),"png",sep=".")
  png(filename2)
  ...
  filename3 = paste(paste(penalty,Hlag_structure,"estimated_plot_MSFE",sep="_"),"png",sep=".")
  png(filename3)
